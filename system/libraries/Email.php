...
class CI_Email {
	...
	var	$smtp_host		= "ssl://gmail.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "jonathanraygarcia@gmail.com";		// SMTP Username
	var	$smtp_pass		= "jomania";		// SMTP Password
